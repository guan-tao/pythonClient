...
#-------------------------模拟接收到的buffer（实际是本地文件中内容）------------------------------
buf1 =''
buf2 =''
buf3 =''
bufList = [buf1,buf2,buf3]

with open(r"..\data\2016-9-7-11\Trainning_data\point0_00_00\CSI00_00.dat","rb") as file:
    while True:
        bytex = file.readline()
        if  bytex:
            bufList[0] +=  bytex
...
with open(r"..\data\2016-9-7-11\Trainning_data\point1_10_00\CSI00_00.dat","rb") as file:
    while True:
        bytex = file.readline()
        if  bytex:
            bufList[1] +=  bytex
...
with open(r"..\data\2016-9-7-11\Trainning_data\point2_10_06\CSI00_00.dat","rb") as file:
    while True:
        bytex = file.readline()
        if  bytex:
            bufList[2] +=  bytex
